  ...
  return (
    <div className="flex min-h-[100dvh] w-full bg-background font-sans text-foreground">
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 p-12 border-r border-border bg-gradient-to-br from-orange-50/60 to-background">
        ...
        <div className="max-w-md space-y-4">
          ...
          <p className="text-4xl font-extrabold tracking-tight text-foreground leading-tight">
            Verify workspace attendance, review ongoing tasks, and monitor system inventories.
          </p>
          <p className="text-gray-500 text-sm leading-relaxed">
            Verify workspace attendance, review ongoing tasks, and monitor system inventories inside our unified SaaS node.
          </p>
        </div>
        <div className="text-xs font-mono text-gray-400 uppercase tracking-widest">
          NODE ACCESS // SYSTEM READY v1.0
        </div>
      </div>
      ...
      >
        ...
        <div className="absolute left-8 bottom-12 font-mono text-[90px] font-extrabold text-gray-100/40 leading-none select-none tracking-tighter pointer-events-none uppercase hidden sm:block">PORTAL</div>
        ...
        <div className="w-full max-w-md mb-3">
          <Breadcrumbs items={[{ label: 'Sign In', href: '/login' }]} />
        </div>
        ...
        <div className="w-full max-w-md bg-white border border-border/80 rounded-lg shadow-xl shadow-gray-100/40 p-8 z-10 relative">
          ...
          <div className="mb-8 text-left">
            ...
            <p className="text-xs text-gray-500 mt-1">Use your registered credentials to access the control panel.</p>
          </div>
